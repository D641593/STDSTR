...
#CUDA_VISIBLE_DEVICES=0 python train.py experiments/seg_detector/syn_resnet50_deform_thre.yaml --num_gpus 1
#CUDA_VISIBLE_DEVICES=0 python train.py experiments/seg_detector/ic15_resnet50_deform_thre.yaml --resume model/model_epoch_1_minibatch_198000 --num_gpus 1
# CUDA_VISIBLE_DEVICES=0 python train.py experiments/seg_detector/ic15_resnet50_deform_thre.yaml --resume model_epoch_361_minibatch_30000 --num_gpus 1  --start_iter 30000 --start_epoch 362
#outputs/workspace/DB-master/SegDetectorModel-seg_detector/deformable_resnet50/L1BalanceCELoss/model/model_epoch_2_minibatch_476000
