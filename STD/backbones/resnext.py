...
__all__ = ['resnext50_32x4d', 'resnext101_32x8d', 'wide_resnet50_2', 'wide_resnet101_2']
...
# __all__ = ['ResNeXt101_32x4d', 'ResNeXt101_64x4d']
...
# #resnext https://github.com/Hsuxu/ResNeXt/blob/master/models.py
...
# resnext101_64x4d_features1 = nn.Sequential(#Sequential,
...
# )
#     #####################256##############
# resnext101_64x4d_features2 = nn.Sequential(#Sequential,
#     nn.Sequential(#Sequential,
#         LambdaMap( #ConcatTable,
#             nn.Sequential(#Sequential,
#                 nn.Sequential(#Sequential,
...
# )
#     ##############512######################
# resnext101_64x4d_features3 = nn.Sequential(#Sequential,
#     nn.Sequential(#Sequential,
#         LambdaMap( #ConcatTable,
#             nn.Sequential(#Sequential,
#                 nn.Sequential(#Sequential,
...
# )
#     #####################1024#####################
# resnext101_64x4d_features4 = nn.Sequential(#Sequential,
#     nn.Sequential(#Sequential,
#         LambdaMap( #ConcatTable,
#             nn.Sequential(#Sequential,
#                 nn.Sequential(#Sequential,
...
#         self.num_classes = num_classes
#         self.features1 = resnext101_64x4d_features1
#         self.features2 = resnext101_64x4d_features2
#         self.features3 = resnext101_64x4d_features3
#         self.features4 = resnext101_64x4d_features4
#         # self.avg_pool = nn.AvgPool2d((7, 7), (1, 1))
#         # self.last_linear = nn.Linear(2048, num_classes)
...
#     def forward(self, input):
#         x2 = self.features1(input)
#         x3 = self.features2(x2)
#         x4 = self.features3(x3)
