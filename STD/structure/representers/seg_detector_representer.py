...
class SegDetectorRepresenter(Configurable):
    ...
    def represent(self, batch, _pred, is_output_polygon=False):
        ...
        boxes_batch = []
        scores_batch = []
        #print("segmentation.............",torch.unique(segmentation))
        for batch_index in range(images.size(0)):
            ...
            if is_output_polygon:
                ...
                boxes, scores = self.boxes_from_bitmap(
                    pred[batch_index],
                    segmentation[batch_index], width, height)
                #print("boxes...................",numpy.unique(boxes))
...
#         num_contours = min(len(contours), self.max_candidates)
        ...
        for index in range(num_contours):
            ...
            if sside >= 200:
                box = self.unclip(points,unclip_ratio=1.3).reshape(-1, 1, 2)
            else:
                box = self.unclip(points,unclip_ratio=2.3 - (sside/200)).reshape(-1, 1, 2)
